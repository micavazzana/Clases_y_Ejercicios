 ...
 **/
 ...
 ///ESTE EJERCICIO YA CONTENIA EL MAIN ESCRITO. SOLO SE ESCRIBIERON DE CERO LAS FUNCIONES DE LA BIBLIOTECA CLIENTE. INCLUI ADEMAS MI PROPIA BIBLIOTECA DE INPUTS
